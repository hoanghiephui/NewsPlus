package net.tichluy.ctinnhanh.ui.base;
...
public abstract class ThemedActivity extends AppCompatActivity {
    ...
    public int primaryColor() {
        ...
        final int defaultColor = getResources().getColor(mLastDarkTheme ?
                R.color.dark_theme_gray : R.color.md_indigo_500);
    ...
    public int accentColor() {
        ...
        final int defaultColor = getResources().getColor(R.color.md_pink_500);
        return PreferenceManager.getDefaultSharedPreferences(this).getInt(key, defaultColor);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ThemeSingleton.get().positiveColor = ColorStateList.valueOf(mLastAccentColor);
        ThemeSingleton.get().neutralColor = ColorStateList.valueOf(mLastAccentColor);
        ThemeSingleton.get().negativeColor = ColorStateList.valueOf(mLastAccentColor);
