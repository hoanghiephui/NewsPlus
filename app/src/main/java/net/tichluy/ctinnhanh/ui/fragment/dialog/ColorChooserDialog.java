package net.tichluy.ctinnhanh.ui.fragment.dialog;
...
import net.tichluy.ctinnhanh.utils.CircleView;
...
public class ColorChooserDialog extends DialogFragment implements View.OnClickListener {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        MaterialDialog dialog = new MaterialDialog.Builder(getActivity())
                ...
                .neutralText(R.string.macdinh)
                .positiveText(R.string.chon)
                .callback(new MaterialDialog.ButtonCallback() {
                    ...
                    public void onNeutral(MaterialDialog dialog) {
                        ...
                        if (getArguments().getInt("title", 0) == R.string.primary_color) {
                            ...
                            getArguments().putInt("preselect", getResources().getColor(R.color.md_pink_500));
                        }
                        invalidateGrid();
                    }
                })
