package net.tichluy.ctinnhanh.ui.fragment.dantri;
...
import net.tichluy.ctinnhanh.ui.fragment.dantri.base.ViewPagerAdapter;

/**
 * Created by Hoang Hiep on 8/1/2015.
 */
public class MainDanTri extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tabLayout.addTab(tabLayout.newTab().setText(getString(R.string.dxahoi)));
        tabLayout.addTab(tabLayout.newTab().setText(getString(R.string.thegioi)));
        tabLayout.addTab(tabLayout.newTab().setText(getString(R.string.dgiaoduc)));
        ...
        tabLayout.addTab(tabLayout.newTab().setText(getString(R.string.dsuckhoe)));
        tabLayout.addTab(tabLayout.newTab().setText(getString(R.string.xe)));
        tabLayout.addTab(tabLayout.newTab().setText(getString(R.string.dsucmanhso)));
